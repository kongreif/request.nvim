...
M.open_post_window = function()
  ...
  vim.api.nvim_buf_set_option(M.buffer_post_params, 'bufhidden', 'wipe')
  ...
  vim.api.nvim_win_set_option(M.window_post_params, 'number', false)
  vim.api.nvim_win_set_option(M.window_post_params, 'relativenumber', false)
  vim.api.nvim_win_set_option(M.window_post_params, 'signcolumn', 'no')
  vim.api.nvim_win_set_option(M.window_post_params, 'fillchars', 'eob: ')
...
M.open_request_view = function()
  ...
  vim.api.nvim_buf_set_option(M.buffer_ui, 'bufhidden', 'wipe')
  ...
  vim.api.nvim_win_set_option(M.window_ui, 'number', false)
  vim.api.nvim_win_set_option(M.window_ui, 'relativenumber', false)
  vim.api.nvim_win_set_option(M.window_ui, 'signcolumn', 'no')
  vim.api.nvim_win_set_option(M.window_ui, 'fillchars', 'eob: ')
