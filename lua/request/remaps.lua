...
M.set_ui_keymaps = function(buffer, input_fields)
  ...
  vim.api.nvim_buf_set_keymap(buffer, 'n', '<CR>', ':lua require("request.ui").handle_request()<CR>', {noremap = true, silent = false})
...
M.set_post_params_keymaps = function(buffer)
  vim.api.nvim_buf_set_keymap(buffer, 'n', 'M', ':lua require("request.ui").toggle_request_method()<CR>', {noremap = true, silent = true})
  vim.api.nvim_buf_set_keymap(buffer, 'n', 'Q', ":close<CR>", {noremap = true, silent = true})
  vim.api.nvim_buf_set_keymap(buffer, 'n', 'P', ':lua require("request.ui").activate_post_params_insert()<CR>', {noremap = true, silent = true})
  vim.api.nvim_buf_set_keymap(buffer, 'n', '<CR>', ':lua require("request.ui").handle_request()<CR>', {noremap = true, silent = false})
end
